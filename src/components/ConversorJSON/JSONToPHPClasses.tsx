	...
	return (
		<>
			...
			<Switch
				...
				onChange={(e) =>
					form.setValue("createPropertiesAsNullable", !!e.currentTarget.checked)
				}
			/>
			<Space h="md" />
				...
				<>
					<MultiSelect
						...
						onChange={(value) =>
							form.setValue(
								"nonNullableProperties",
								value as TForm["nonNullableProperties"]
							)
						}
						data={
							[
								...
								"int",
								"string",
							] as TForm["nonNullableProperties"]
						}
					/>
					<Space h="md" />
				</>
			...
			<Switch
				...
				onChange={(e) =>
					form.setValue("createGetters", !!e.currentTarget.checked)
				}
			/>
			<Space h="md" />
			...
			<Switch
				...
				onChange={(e) =>
					form.setValue("createSetters", !!e.currentTarget.checked)
				}
			/>
			<Space h="md" />
			...
			{createSetters && (
				<>
					<Switch
						...
						onChange={(e) =>
							form.setValue("useAddMethodForArray", !!e.currentTarget.checked)
						}
					/>
					<Space h="md" />
					<Switch
						...
						onChange={(e) =>
							form.setValue("useFluentSetters", !!e.currentTarget.checked)
						}
					/>
				</>
			)}
			...
			<Space h="md" />
			<Group>
				<Button disabled={!json} onClick={handleOpen}>
					Convert
				</Button>
				<Button
					variant="subtle"

...
export const Shell: React.FC = ({ children }) => {
	...
	return <AppShell
		...
		fixed
		header={<Header height={70} p="md" {...styles("dark", isMobile).bg}>
			{/* Handle other responsive styles with MediaQuery component or createStyles function */}
			<div style={{ display: 'flex', alignItems: 'center', height: '100%', margin: "0 auto", maxWidth: 960 }}>

				<Group p="md" position="apart" sx={{ width: '100%', alignItems: "center" }}>
					<Link href="/">
						<Text sx={{
					...
					<Link href="/about">
						<Flex direction="row" align="center" gap={16} sx={{ cursor: "pointer" }}>

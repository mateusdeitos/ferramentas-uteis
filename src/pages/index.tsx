...
export const appSections = [
	{
		...
		items: [
			...
			{
				title: "Flexbox simulator",
				description: "Simulate flexbox behaviour",
				href: "/flexbox-simulator",
			},
		],
	},
	{
		...
		items: [
			{
				...
				description:
					"Calculate the final amount of a value applied to an interest rate or calculate the interest rate needed to reach a final amount",
